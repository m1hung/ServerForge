...
export const config = {
  ...
  setupTokenHash: env('SETUP_TOKEN_HASH'),
  ...
  upnpLeaseSeconds: envInt('UPNP_LEASE_SECONDS', 3600),
  tailscaleSocket: env('TAILSCALE_SOCKET', '/var/run/serverforge-tailscale/tailscaled.sock'),
  tailscaleProxyTarget: env('TAILSCALE_PROXY_TARGET', 'http://web:3000'),
  tailscaleHostname: env('TS_HOSTNAME', 'serverforge'),
